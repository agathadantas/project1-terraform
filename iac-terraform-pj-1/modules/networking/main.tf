...
## Create the company infrastructure - VPC
resource "aws_vpc" "vpc_network" {
  ...
  tags = {
    Name        = "pj-cd-acloud-${var.project}-${var.environment}-vpc"
    Entity      = "pj"
    Unit        = "cd"
    Team        = "acloud"
    Project     = "${var.project}"
...
resource "aws_subnet" "public_subnet" {
  ...
  tags = {
    Name        = "pj-cd-acloud-${var.project}-public-${var.environment}-snet"
    Entity      = "pj"
    Unit        = "cd"
    Team        = "ACloud"
    Project     = "${var.project}"
...
resource "aws_subnet" "private_subnet" {
  ...
  tags = {
    Name        = "pj-cd-acloud-${var.project}-private-${var.environment}-snet"
    Entity      = "pj"
    Unit        = "cd"
    Team        = "ACloud"
    Project     = "${var.project}"
...
resource "aws_internet_gateway" "internet_gateway" {
  ...
  tags = {
    Name        = "pj-cd-acloud-${var.project}-${var.environment}-igw"
    Entity      = "pj"
    Unit        = "cd"
    Team        = "ACloud"
    Project     = "${var.project}"
...
resource "aws_nat_gateway" "nat_gateway_public" {
  ...
  tags = {
    Name        = "pj-cd-acloud-${var.project}-${var.environment}-ngw"
    Entity      = "pj"
    Unit        = "cd"
    Team        = "ACloud"
    Project     = "${var.project}"
...
resource "aws_route_table" "route_table_public" {
  ...
  tags = {
    Name        = "pj-cd-acloud-${var.project}-public-${var.environment}-rt"
    Entity      = "pj"
    Unit        = "cd"
    Team        = "ACloud"
    Project     = "${var.project}"
...
resource "aws_route" "private_route" {
  ...
  destination_cidr_block = "0.0.0.0/0"
  nat_gateway_id         = aws_nat_gateway.nat_gateway_public.*.id[count.index]
}
...
resource "aws_route_table" "route_table_private" {
  ...
  tags = {
    Name        = "pj-cd-acloud-${var.project}-private-${var.environment}-rt"
    Entity      = "pj"
    Unit        = "cd"
    Team        = "ACloud"
    Project     = var.project
...
resource "aws_eip" "elastic_ip" {
  ...
  tags = {
    Name        = "pj-cd-acloud-${var.project}-${var.environment}-eip"
    Entity      = "pj"
    Unit        = "cd"
    Team        = "ACloud"
    Project     = var.project
...
resource "aws_db_subnet_group" "database_subnetgroup" {
  ...
  name       = "pj-cd-acloud-${var.project}-${var.environment}-rds-sn"
